...
OPTIONAL_ENV_VARS = {
    ...
    "THREEDS_ENABLED": {
        "description": "Enable the native Nintendo 3DS gateway adapter (true/false).",
    ...
    "THREEDS_HOST": {
        "description": "Host/bind address for the 3DS gateway (default: 127.0.0.1). Use 0.0.0.0 for LAN access from the handheld.",
        "prompt": "3DS gateway host",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "THREEDS_PORT": {
        "description": "Port for the 3DS gateway HTTP server (default: 8787).",
        "prompt": "3DS gateway port",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "THREEDS_AUTH_TOKEN": {
        "description": "Bearer/query token required by the 3DS client when the gateway is exposed beyond loopback.",
        "prompt": "3DS gateway auth token",
        "url": None,
        "password": True,
        "category": "messaging",
    },
    "THREEDS_DEVICE_ID": {
        "description": "Default 3DS device ID to accept when the handheld omits one (optional).",
        "prompt": "Default 3DS device ID (optional)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
